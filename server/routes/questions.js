...
const QUESTIONS = {
    0: [
        { text: "Question 1.1", type: "image", modality: "voice", content: "Create a prompt to generate an image of a futuristic city with flying cars and holographic billboards. Include details about lighting, atmosphere, and architectural style." },
    ...
    1: [
        { text: "Question 2.1", type: "text", modality: "voice", content: "Write a short story about a detective who solves a mysterious crime in a futuristic city. Include details about the crime scene, suspects, and the detective's methods." },
    ...
    6: [
        ...
        { text: "Question 7.2", type: "text", modality: "voice", content: "Write a dialogue between two characters who are stranded on a deserted island. Include details about their personalities, motivations, and survival strategies." },
    ...
    7: [
        { text: "Question 8.1", type: "text", modality: "voice", content: "Write a short story about a time traveler who discovers a hidden portal to another dimension. Include details about the time period, location, and the traveler's journey." },
    ...
    8: [
        { text: "Question 9.1", type: "text", modality: "voice", content: "Write a dialogue between two characters who are stranded on a deserted island. Include details about their personalities, motivations, and survival strategies." },
    ...
    9: [
        { text: "Question 10.1", type: "text", modality: "voice", content: "Write a poem about the beauty of nature and the changing seasons. Include vivid descriptions of the landscape, weather, and wildlife." },
